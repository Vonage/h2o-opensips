...
#define F_CONN_ACCEPTED			(1<<1) /*!< created after a connect event */
#define F_CONN_REMOVED_READ		(1<<2) /*!< no longer in "main" reactor for read */
#define F_CONN_REMOVED_WRITE	(1<<3) /*!< no longer in "main" reactor for write */
